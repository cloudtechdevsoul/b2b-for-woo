		...
		<table class="wp-list-table widefat fixed striped table-view-list customers dataTable">
			...
			<tbody>
				...
				<?php foreach ($all_post_id as $current_post_id) {
					...
					echo wp_kses(get_role_base_and_customer_base_pricing( $current_post_id , 'customer' ),wp_kses_allowed_html('post'));					
				} ?>
		...
		<table class="wp-list-table widefat fixed striped table-view-list customers dataTable">
			...
			<tbody>
				<?php foreach ($all_post_id as $current_post_id) {
					...
					echo wp_kses(get_role_base_and_customer_base_pricing( $current_post_id , 'user_role' ),wp_kses_allowed_html('post'));
				} ?>
			</tbody>
		</table>
