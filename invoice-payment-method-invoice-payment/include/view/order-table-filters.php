                ...
                <tbody>
                    ...
                    foreach ($all_orders as $order_id) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo wp_kses(str_replace(',', '', wc_price($order->get_subtotal())),wp_kses_allowed_html('post')); ?>
                            </td>

                            <td>
                                <?php echo wp_kses(str_replace(',', '', wc_price($order->get_total())),wp_kses_allowed_html('post')); ?> <input
                ...
                <table>
                    ...
                    <tr class="ct-psbs-subtotal">
                        ...
                        <td class="ct-psbs-subtotal-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_subtotal)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                    <tr class="ct-psbs-total-tax">
                        ...
                        <td class="ct-psbs-total-tax-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_tax_total)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                    <tr class="ct-psbs-shipping-total">
                        ...
                        <td class="ct-psbs-shipping-total-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_shipping_total)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                    <tr class="ct-psbs-coupon-total">
                        ...
                        <td class="ct-psbs-coupon-total-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_all_coupon_amount)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                    <tr class="ct-psbs-refunded-total">
                        ...
                        <td class="ct-psbs-refunded-total-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_refunded_amount)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                    <tr class="ct-psbs-total">
                        ...
                        <td class="ct-psbs-total-td">
                            <?php echo wp_kses(str_replace(',', '', wc_price($sum_of_total)),wp_kses_allowed_html('post')); ?>
                        </td>
                    </tr>
                </table>
            </div>
