                    ...
                    <tr class="item" data-order_item_id="<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php if (in_array('item', (array) $psd_csv_coulmn)) { ?>
                            <td class="woocommerce-table__product-name product-name"
                                ...
                                <br>
                                <?php echo wp_kses('<div class="wc-quote-item-sku" style="font-size:12x; margin-top:10px;"><strong style="font-size:12px;">' . esc_html__('SKU:', 'cloud_tech_rfq') . '</strong> ' . esc_attr($product->get_sku()) . '</div>',wp_kses_allowed_html('post')); ?>
                            </td>
                        ...
                        <?php if (in_array('price', (array) $psd_csv_coulmn)) { ?>
                            <td class="woocommerce-table__product-total product-total"
                                ...
                                <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal($price, wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                            </td>
                        ...
                        <?php if (in_array('subtotal', (array) $psd_csv_coulmn)) { ?>
                            <td class="woocommerce-table__product-total product-total"
                                ...
                                <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal($price * $quantity, wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                            </td>
                        <?php } ?>
                        <?php if (in_array('offered_price', (array) $psd_csv_coulmn)) { ?>
                            <td style="padding: 15px 20x; text-align:center; color:#000; font-size: 13px; width: 15%;"
                                ...
                                <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal($custom_price, wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                            </td>
                        <?php } ?>
                        <?php if (in_array('offered_subtotal', (array) $psd_csv_coulmn)) { ?>
                            <td style="padding: 15px 20x; text-align:center; color:#000; font-size: 13px; width: 15%;"
                                data-title="<?php esc_attr_e('Offered Price', 'cloud_tech_rfq'); ?>">
                                <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal($custom_price * $quantity, wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                            </td>
                        <?php } ?>
            ...
            <?php if (get_option('ct_rfq_enable_term_and_conditions')) { ?>
                <div class="afrfq_client_info_details"
                    ...
                    <ul style="padding-left:13px; font-size:13px;  line-height: 10px;">
                        <li>
                            <?php echo wp_kses(get_option('ct_rfq_term_and_condition_data'),wp_kses_allowed_html('post')); ?>
                        </li>
                    </ul>
                </div>
                <?php
                        ...
                        <tbody>
                            <?php if (in_array('quote_subtotal', (array) $psd_csv_coulmn)) { ?>
                                <tr
                                    ...
                                    <td
                                        ...
                                        <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal(wc_get_quote_subtotal_ct($qoute_id), wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                                    </td>
                                </tr>
                                <?php
                            } ?>
                            <?php if (in_array('quote_offered_total', (array) $psd_csv_coulmn)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding-top:10px; padding-bottom:10px;padding-left:10px; padding-right:20px;  color:#000; font-size: 14px; text-align:left;">
                                        <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal($offered_total, wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                                    </td>
                                </tr>
                            ...
                            <?php if (in_array('quote_total_tax', (array) $psd_csv_coulmn)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding-top:10px; padding-bottom:10px;padding-left:10px; padding-right:20px; color:#000; font-size: 14px; text-align:left;">
                                        <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal(wc_get_quote_tax_ct($qoute_id), wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                            ...
                            <?php if (in_array('quote_total_total', (array) $psd_csv_coulmn)) { ?>
                                <tr style="background-color:<?php echo esc_attr($afrfq_backrgound_color); ?>;">
                                    ...
                                    <td
                                        ...
                                        <?php echo wp_kses(get_woocommerce_currency_symbol() . ' ' . wc_format_decimal(wc_get_quote_total_ct($qoute_id), wc_get_price_decimals()),wp_kses_allowed_html('post')); ?>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
